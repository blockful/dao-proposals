...
interface CFAv1Forwarder {
    ...
    function createFlow(address token, address sender, address receiver, int96 flowrate, bytes memory userData)
        external
        returns (bool);
    function deleteFlow(address token, address sender, address receiver, bytes memory userData)
        external
        returns (bool);
    ...
    function getFlowInfo(address token, address sender, address receiver)
        ...
        view
        returns (uint256 lastUpdated, int96 flowrate, uint256 deposit, uint256 owedDeposit);
    function getFlowOperatorPermissions(address token, address sender, address flowOperator)
        external
        view
    ...
    function updateFlow(address token, address sender, address receiver, int96 flowrate, bytes memory userData)
        external
        returns (bool);
