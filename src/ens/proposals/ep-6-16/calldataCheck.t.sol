...
contract Proposal_ENS_EP_6_16_Test is ENS_Governance {
    ...
    string baseCoinType = bytes4ToHexString(bytes4(uint32(2_147_492_101)));
    string arbitrumCoinType = bytes4ToHexString(bytes4(uint32(2_147_525_809)));
    string scrollCoinType = bytes4ToHexString(bytes4(uint32(2_148_018_000)));
    string optimismCoinType = bytes4ToHexString(bytes4(uint32(2_147_483_658)));
    string lineaCoinType = bytes4ToHexString(bytes4(uint32(2_147_542_792)));
    ...
    function _beforeProposal() public view override {
        ...
        assertEq(
            newEthRegistrarController.owner(), address(timelock), "newEthRegistrarController owner is not timelock"
        );
        ...
        returns (address[] memory, uint256[] memory, string[] memory, bytes[] memory, string memory)
    {
        ...
        calldatas[0] = abi.encodeWithSelector(
            IENSRegistryWithFallback.setResolver.selector, namehash("reverse"), newDefaultReverseResolver
        );
        signatures[0] = "";
        ...
        values[6] = 0;
        calldatas[6] = abi.encodeWithSelector(IENSRegistrar.addController.selector, newEthRegistrarController);
        signatures[6] = "";
        ...
        values[7] = 0;
        calldatas[7] =
            abi.encodeWithSelector(IENSReverseRegistrar.setController.selector, newEthRegistrarController, true);
        signatures[7] = "";
        ...
        values[8] = 0;
        calldatas[8] =
            abi.encodeWithSelector(IENSNewReverseRegistrar.setController.selector, newEthRegistrarController, true);
        signatures[8] = "";
        ...
        values[10] = 0;
        calldatas[10] = abi.encodeWithSelector(IENSReverseRegistrar.setDefaultResolver.selector, newPublicResolver);
        signatures[10] = "";
        ...
        calldatas[11] = abi.encodeWithSelector(
            IENSReverseRegistrar.setNameForAddr.selector, dnssecEnsAddr, timelock, newPublicResolver, "dnssec.ens.eth"
        );
        signatures[11] = "";
        ...
        calldatas[12] = abi.encodeWithSelector(
            IENSReverseRegistrar.setNameForAddr.selector, ensRegistrar, timelock, newPublicResolver, "registrar.ens.eth"
        );
        signatures[12] = "";
        ...
        calldatas[13] = abi.encodeWithSelector(
            IENSReverseRegistrar.setNameForAddr.selector, rootEnsAddr, timelock, newPublicResolver, "root.ens.eth"
        );
        signatures[13] = "";
    ...
    function _afterExecution() public view override {
        ...
        assertEq(
            ensRegistry.resolver(namehash("reverse")), newDefaultReverseResolver, "Reverse resolver not set correctly"
        );
        ...
        assertTrue(
            ensRegistrar.controllers(address(newEthRegistrarController)), "New ETH registrar controller not added"
        );
        ...
        assertEq(reverseRegistrar.defaultResolver(), newPublicResolver, "Default resolver not set correctly");

        // 8. Verify that reverse names were set for ENS addresses
        assertEq(
            ensRegistry.resolver(reverseRegistrar.node(dnssecEnsAddr)), newPublicResolver, "DNSSEC reverse name not set"
        );
        assertEq(
        ...
        assertEq(
            ensRegistry.resolver(reverseRegistrar.node(rootEnsAddr)), newPublicResolver, "Root reverse name not set"
        );
        assertEq(
