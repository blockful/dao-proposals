...
[Temp Check Discourse link](https://discuss.ens.domains/t/ep-5-x-executable-reimbursement-of-ens-labs-legal-fees-in-eth-link-litigation/19613)
 ...
 ## Description 
## Summary
This executable proposal seeks to implement the reimbursement payment to ENS Labs for the legal fees incurred while pursuing litigation to protect the eth.link domain. The reimbursement was approved in the previously passed social proposal [EP 5.3](https://docs.ens.domains/dao/proposals/5.3).
